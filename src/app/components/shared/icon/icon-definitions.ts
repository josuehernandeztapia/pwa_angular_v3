...
const ICON_LIBRARY: Record<IconName, IconDefinition> = {
  ...
  'folder': {
    viewBox: '0 0 24 24',
    shapes: [
      { type: 'path', d: 'M3 7v10a2 2 0 002 2h14a2 2 0 002-2V9a2 2 0 00-2-2h-5L9 5H5a2 2 0 00-2 2z', strokeLinecap: 'round', strokeLinejoin: 'round' }
    ]
  },
  'external-link': {
    viewBox: '0 0 24 24',
  ...
  'shield-check': {
    ...
    shapes: [
      ...
      { type: 'polyline', points: '9 12 12 15 16 10', strokeLinecap: 'round', strokeLinejoin: 'round' }
    ]
  },
  'alert-circle': {
    viewBox: '0 0 24 24',
  ...
  'piggy-bank': {
    viewBox: '0 0 24 24',
    shapes: [
      { type: 'path', d: 'M12 2C8.686 2 6 4.686 6 8v1H4a2 2 0 00-2 2v6a2 2 0 002 2h1v1a2 2 0 002 2h10a2 2 0 002-2v-1h1a2 2 0 002-2v-6a2 2 0 00-2-2h-2V8c0-3.314-2.686-6-6-6z', strokeLinecap: 'round', strokeLinejoin: 'round' },
      { type: 'circle', cx: '15', cy: '11', r: '1' },
      { type: 'path', d: 'M12 15v2', strokeLinecap: 'round', strokeLinejoin: 'round' }
    ]
  },
  'trending-up': {
    viewBox: '0 0 24 24',
  ...
  'clipboard-list': {
    viewBox: '0 0 24 24',
    shapes: [
      { type: 'path', d: 'M16 4h2a2 2 0 012 2v14a2 2 0 01-2 2H6a2 2 0 01-2-2V6a2 2 0 012-2h2', strokeLinecap: 'round', strokeLinejoin: 'round' },
      { type: 'rect', x: '8', y: '2', width: '8', height: '4', rx: '1', ry: '1' },
      { type: 'line', x1: '9', y1: '12', x2: '15', y2: '12', strokeLinecap: 'round', strokeLinejoin: 'round' },
      { type: 'line', x1: '9', y1: '16', x2: '15', y2: '16', strokeLinecap: 'round', strokeLinejoin: 'round' }
    ]
  }
};
